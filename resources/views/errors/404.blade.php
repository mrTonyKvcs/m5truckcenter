...
<html lang='en'>
  <!-- <![endif] -->
  <head>
    <title>404 | M5 Truck Center</title>
    ...
    <div id='wrapper'>
      <div class='container'>
        <div class='row'>
          <div class='col-sm-12'>
            <h1 class='code fadeInDown animated'>
              <span>4</span>
              <span style="color: #163762;" class='fa fa-question-circle'></span>
              <span>4</span>
            </h1>
          </div>
        </div>
        ...
        <div class='row'>
          <div class='col-sm-12'>
            <a href='index.html'>
              <img class="logo fadeInUp animated" alt="NONSTOP TRUCK SERVICE" width="255" height="55" src="/images/logo.png" />
            </a>
          </div>
        </div>
      </div>
